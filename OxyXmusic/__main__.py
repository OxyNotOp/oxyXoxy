...
from OxyXmusic import (ASSID, ASSMENTION, ASSNAME, ASSUSERNAME, BOT_ID, BOT_NAME,
...
async def initiate_bot():
    with console.status(
        "[magenta] Booting up The OxyXmusic Music Bot...",
    ) as status:
    ...
    try:
        ...
        return
    try:
        await userbot.join_chat("OfficialOxyXmusic")
    except:
        pass
