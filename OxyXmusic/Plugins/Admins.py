...
from OxyXmusic.Inline import audio_markup, primary_markup
...
from OxyXmusic.Utilities.youtube import get_yt_info_id
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "e":
        ...
        await OxyXmusic.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text(
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await OxyXmusic.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(
